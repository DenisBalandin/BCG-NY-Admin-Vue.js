  ...
  >
    ...
    >
      ...
      <template slot="links">
        ...
        <sidebar-item :link="{ name: 'Private Dining', icon: 'contacts', path: '/privatedining' }"></sidebar-item>
        <sidebar-item :link="{ name: 'Catering', icon: 'contacts', path: '/catering' }"></sidebar-item>

        ...
        <md-card-content>
          ...
          >
            <md-table-toolbar>
              ...
              <md-field>
                <md-button class="md-primary md-round md-small" @click="newKiosk"
                  >Add a new Kiosk</md-button
                >
              </md-field>
            ...
            <md-table-row slot="md-table-row" slot-scope="{ item }">
              <md-table-cell md-label="Kiosk" md-sort-by="name">
                {{ item.name }}
              </md-table-cell>
              <md-table-cell md-label="Description" md-sort-by="description">
                {{ item.description }}
              </md-table-cell>
              <md-table-cell md-label="Last Signal" md-sort-by="last_signal">
                {{ item.last_signal }}
              </md-table-cell>
              <md-table-cell md-label="URL" md-sort-by="slug">
                <p @click='openLink(item.slug)' class='icon_txt'>{{item.slug}}
                  <md-button
...
export default {
  ...
  firestore() {
    return {
      tableData: db.collection("kiosks")
    };
  },
  methods: {
    openLink(slug){
    ...
    newKiosk() {
      let ref = db.collection("kiosks").doc();
      this.handleEdit(ref);
    },
    handleEdit(item) {
      let id = item.id;
